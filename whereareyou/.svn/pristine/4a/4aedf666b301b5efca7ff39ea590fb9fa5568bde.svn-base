...
<table width="100%" height="37" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td background="<c:url value='/whereareyou/images/ct_ttl_img02.gif'/>" width="100%" style="padding-left: 10px;">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px;">
		<tr>
			<td height="24" colspan="2" align="center">
				<c:if test="${empty movie.movieId}">
					<a id="createlink" href="javascript:fncCreateMovie();"><img src="<c:url value='/whereareyou/images/btn_add.png'/>" width="64" height="18" border="0" /></a>
					<script type="text/javascript">
					    Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'createlink', event:'onclick'}));
					</script>
				</c:if>
				<c:if test="${not empty movie.movieId}">
					<a id="updatelink" href="javascript:fncUpdateMovie();"><img src="<c:url value='/whereareyou/images/btn_update.png'/>" width="64" height="18" border="0" /></a>
					<script type="text/javascript">
					    Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'updatelink', event:'onclick'}));
					</script>
					<a href="javascript:fncRemoveMovie();"><img src="<c:url value='/whereareyou/images/btn_delete.png'/>" width="64" height="18" border="0" /></a>
				</c:if>
			</td>
		</tr>
	</table>
