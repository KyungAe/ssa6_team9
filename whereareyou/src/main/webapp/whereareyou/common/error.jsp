...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td width="747">
			<table width="370" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="5">
						<img src="<c:url value='/whereareyou/images/empty.gif'/>" width="1" height="120">
					</td>
				</tr>
			</table>
		</td>
	...
	<tr>
		<td align="center">
			<table width="375" height="153" border="0" cellpadding="0" cellspacing="0" background="<c:url value='/whereareyou/images/fail.jpg'/>">
				<tr>
					<td height="153">
						<table>
							<tr>
