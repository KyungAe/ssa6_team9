...
<head>
	...
	<script type="text/javascript">
		function fncCreateMovieView() {
			document.location.href="<c:url value='/foundationMovie.do?method=createView'/>";
		}	
		function fncSearchMovie(arg) {
		   	document.searchForm.action="<c:url value='/foundationMovieFinder.do?method=list'/>";
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px; vertical-align: center;">
		<tr>
			...
			<td align="right" width="35">
				<a href="javascript:fncSearchMovie();"><img src="<c:url value='/whereareyou/images/btn_search.png'/>" width="25" height="18" border="0" align="middle"/></a>
			</td>
		</tr>
	</table>
	<!--end of search-->
		...
		<tbody>
			<c:forEach var="movie" items="${movies}">
				<tr class="board" onMouseOver="this.style.backgroundColor='#e4eaff';return true;" onMouseOut="this.style.backgroundColor=''; return true;" >
					...
					<td class="underline">
						<a class="linkClass" href="${ctx}/foundationMovie.do?method=get&movieId=${movie.movieId}">${movie.title}</a>
					</td>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px;">
		<tr>
			<td align="right"><a href='<c:url value="javascript:fncCreateMovieView();" />'><img
				src="<c:url value='/whereareyou/images/btn_add.png'/>" width="64" height="18" border="0" /></a></td>
		</tr>
	</table>
</form:form>