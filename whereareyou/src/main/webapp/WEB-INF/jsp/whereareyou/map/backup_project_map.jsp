...
게시판 목록 끝 -->
		...
		<c:forEach var="project" items="${projects}">
		<script>
				var testDupSpriteIcon_second = new nhn.api.map.SpriteIcon(testdefaultSpriteIcon.url, testdefaultSpriteIcon.size, testdefaultSpriteIcon.spriteSize, 1, testdefaultSpriteIcon.offset);
				...
				mapInfoTestWindow2.setContent(
						...
						'좌표:(' + oPointMarker.getX() + ','+ oPointMarker.getY() + ')<br/>'+
